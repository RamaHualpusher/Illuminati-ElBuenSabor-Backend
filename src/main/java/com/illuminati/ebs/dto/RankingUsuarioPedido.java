...
public class RankingUsuarioPedido {
    ...
    public RankingUsuarioPedido(Long id, boolean activo, String nombre, String apellido, String email, String telefono, Domicilio domicilio, Rol rol, List<Pedido> pedidos) {
        this.id = id;
        this.activo = activo;
        this.nombre = nombre;
